...
# base_dir = '/home/xjm/MoveSim/data/traffic' # 原始数据路径

GEN_PATH = '/home/xjm/MoveSim/data1/traffic/' #生成数据路径

print(GEN_PATH)
if not os.path.exists(GEN_PATH):  #判断是否存在文件夹如果不存在则创建为文件夹
...
def get_eid_dic(file_name=GEN_PATH + 'eid2id.json')->dict:
