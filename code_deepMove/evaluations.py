...
class IndividualEval(object):
    ...
    def __init__(self, data):
        if data == 'mobile':       
            ...
            self.X, self.Y = get_gps('../data/traffic/gps')
            self.max_locs = 46165
            self.max_distance = 1.228
        elif data == 'traffic_hash1':
            self.X, self.Y = get_gps('../data/traffic_hash1/gps')
            self.max_locs = 5288
            self.max_distance = 13547.346  
        else:
